...
include_once 'apache_log_parser.php';

$apache_log_parser = new apache_log_parser(); // Create an apache log parser
$filename = '/var/log/apache2/access.log';

if ($apache_log_parser->open_log_file($filename)) // Make sure it opens the log file
{
	$i = 1;
	while ($line = $apache_log_parser->get_line($filename)) { // while it can get a line
